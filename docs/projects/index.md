...
Freetime Docs contains the documentation for actively maintained Freetime Maker projects.

## Applications

- [GeoWeather](/projects/geoweather/) — Android weather application.
...
- [All API](/projects/all-api/) — Central backend for Freetime Maker services.
- [MD-Blog](/projects/md-blog/) — Markdown-powered blog platform.
